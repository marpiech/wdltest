...
class Wdltest(object):
    ...
    def __init__(self, testConfigFile = os.path.dirname(__file__) + "/test_config.json", configFile = os.path.dirname(__file__) + "/wdltest.cfg"):
        ...
        self.testRunner = TestRunner(testConfig, self.cromwell)
